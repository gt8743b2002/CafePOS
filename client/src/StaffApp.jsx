...
export default function StaffApp({ onExitToLanding }) {
  ...
  if (!user) {
    return <LoginPage onLogin={setUser} onBack={onExitToLanding} />;
  }
      ...
      <div className="app admin">
        <header className="app-header">
          <div className="app-title">
            ...
            CafePOS — {isHistory ? 'Sales History' : 'Live Orders'}
          </div>
        ...
        <div className="admin-body">
          {isHistory ? <HistoryTab user={user} /> : <OrdersQueue />}
        </div>
      </div>
    );
  }
    ...
    <div className="app">
      <header className="app-header">
        ...
        <div className="header-actions">
          ...
          <button className="btn" onClick={() => setView('orders')}>Live Orders</button>
